...
prop_compose! {
    fn ethernet_2_with(ether_type: u16)(source in prop::array::uniform6(any::<u8>()),
...
prop_compose! {
    fn ipv6_extension_with(next_header: u8,
                           len: u8)
                          (next_header in proptest::strategy::Just(next_header),
