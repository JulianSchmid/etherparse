    ...
    fn is_fragmenting_payload() {
        for fragment in [false, true] {
            // ipv4
            {
                ...
                assert_eq!(
                    fragment,
                    InternetSlice::Ipv4(ipv4_slice, Ipv4ExtensionsSlice { auth: None })
            ...
            // ipv6
            {
                ...
                assert_eq!(
                    ...
                    InternetSlice::Ipv6(
                        ...
                        Ipv6ExtensionsSlice::from_slice(ip_number::IPV6_FRAG, &ipv6_frag_data)
                            .unwrap()
                            .0
                    )
                    .is_fragmenting_payload()
    ...
    fn source_addr() {
        // ipv4
        {
            ...
            assert_eq!(
                ...
                InternetSlice::Ipv4(ipv4_slice, Ipv4ExtensionsSlice { auth: None }).source_addr()
            );
        }
