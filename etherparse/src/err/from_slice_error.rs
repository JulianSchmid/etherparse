...
mod tests {
    ...
    fn from() {
        ...
        // ip errors
        {
            ...
            assert_eq!(
                &header_error(),
                FromSliceError::from(ip::HeaderSliceError::Content(header_error()))
                    .ip()
                    .unwrap()
            );
            assert_eq!(
                &len_error(),
                FromSliceError::from(ip::HeaderSliceError::Len(len_error()))
                    .len()
                    .unwrap()
            );
            assert_eq!(
            ...
            assert_eq!(
                &header_error(),
                FromSliceError::from(ip::SliceError::IpHeader(header_error()))
                    .ip()
                    .unwrap()
            );
        }
