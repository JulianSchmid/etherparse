...
impl From<ip::HeaderSliceError> for FromSliceError {
...
impl From<ip::SliceError> for FromSliceError {
    fn from(value: ip::SliceError) -> Self {
        ...
        match value {
            Len(err) => FromSliceError::Len(err),
            IpHeader(err) => FromSliceError::Ip(err),
        }
    }
}
...
mod tests {
    ...
    fn from() {
        ...
        // len
        assert_eq!(&len_error(), FromSliceError::from(len_error()).len().unwrap());
        ...
        // double vlan errors
        {
            ...
            assert_eq!(&header_error(), FromSliceError::from(header_error()).double_vlan().unwrap());
            assert_eq!(
                &header_error(),
                FromSliceError::from(
        ...
        // ip errors
        {
            ...
            assert_eq!(&header_error(), FromSliceError::from(header_error()).ip().unwrap());
            assert_eq!(
                &header_error(),
                FromSliceError::from(
        ...
        // ip auth errors
        {
            ...
            assert_eq!(&header_error(), FromSliceError::from(header_error()).ip_auth().unwrap());
            assert_eq!(
                &header_error(),
                FromSliceError::from(
        ...
        // ipv4 errors
        {
            ...
            assert_eq!(&header_error(), FromSliceError::from(header_error()).ipv4().unwrap());
            assert_eq!(
                &header_error(),
                FromSliceError::from(
        ...
        // ipv6 errors
        {
            ...
            assert_eq!(&header_error(), FromSliceError::from(header_error()).ipv6().unwrap());
            assert_eq!(
                &header_error(),
                FromSliceError::from(
        ...
        // ipv6 exts errors
        {
            ...
            assert_eq!(&header_error(), FromSliceError::from(header_error()).ipv6_exts().unwrap());
            assert_eq!(
                &header_error(),
                FromSliceError::from(
        ...
        // tcp errors
        {
            ...
            assert_eq!(&header_error(), FromSliceError::from(header_error()).tcp().unwrap());
            assert_eq!(
                &header_error(),
                FromSliceError::from(
