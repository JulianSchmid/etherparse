...
impl core::fmt::Debug for LinuxNonstandardEtherType {
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match *self {
            ...
            LinuxNonstandardEtherType::N802_3 => write!(f, "{:#06X} (Dummy type for 802.3 frames)", self.0),
            LinuxNonstandardEtherType::AX25 => write!(f, "{:#06X} (Dummy protocol id for AX.25)", self.0),
            ...
            LinuxNonstandardEtherType::DDCMP => write!(f, "{:#06X} (DEC DDCMP: Internal only)", self.0),
            LinuxNonstandardEtherType::WAN_PPP => write!(f, "{:#06X} (Dummy type for WAN PPP frames)", self.0),
            LinuxNonstandardEtherType::PPP_MP => write!(f, "{:#06X} (Dummy type for PPP MP frames)", self.0),
            LinuxNonstandardEtherType::LOCALTALK => write!(f, "{:#06X} (Localtalk pseudo type)", self.0),
            LinuxNonstandardEtherType(0x000A..=0x000B) => write!(f, "{:#06X} (Unknown)", self.0),
            LinuxNonstandardEtherType::CAN => write!(f, "{:#06X} (CAN: Controller Area Network)", self.0),
            LinuxNonstandardEtherType::CANFD => write!(f, "{:#06X} (CANFD: CAN flexible data rate)", self.0),
            LinuxNonstandardEtherType::CANXL => write!(f, "{:#06X} (CANXL: eXtended frame Length)", self.0),
            LinuxNonstandardEtherType(0x000F) => write!(f, "{:#06X} (Unknown)", self.0),
            LinuxNonstandardEtherType::PPPTALK => write!(f, "{:#06X} (Dummy type for Atalk over PPP)", self.0),
            ...
            LinuxNonstandardEtherType::CONTROL => write!(f, "{:#06X} (Card specific control frames)", self.0),
            ...
            LinuxNonstandardEtherType::DSA => write!(f, "{:#06X} (Distributed Switch Arch)", self.0),
            LinuxNonstandardEtherType::TRAILER => write!(f, "{:#06X} (Trailer switch tagging)", self.0),
            ...
            LinuxNonstandardEtherType::IEEE802154 => write!(f, "{:#06X} (IEEE802.15.4 frame)", self.0),
            LinuxNonstandardEtherType::CAIF => write!(f, "{:#06X} (ST-Ericsson CAIF protocol)", self.0),
            LinuxNonstandardEtherType::XDSA => write!(f, "{:#06X} (Multiplexed DSA protocol)", self.0),
            LinuxNonstandardEtherType::MAP => write!(f, "{:#06X} (Qualcomm multiplexing and aggregation protocol)", self.0),
            LinuxNonstandardEtherType::MCTP => write!(f, "{:#06X} (Management component transport protocol packets)", self.0),
...
mod test {
    ...
    #[test]
    fn try_from_u16() {
        assert_eq!(LinuxNonstandardEtherType::try_from(0x0001), Ok(LinuxNonstandardEtherType::N802_3));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x0002), Ok(LinuxNonstandardEtherType::AX25));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x0003), Ok(LinuxNonstandardEtherType::ALL));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x0004), Ok(LinuxNonstandardEtherType::N802_2));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x0005), Ok(LinuxNonstandardEtherType::SNAP));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x0006), Ok(LinuxNonstandardEtherType::DDCMP));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x0007), Ok(LinuxNonstandardEtherType::WAN_PPP));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x0008), Ok(LinuxNonstandardEtherType::PPP_MP));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x0009), Ok(LinuxNonstandardEtherType::LOCALTALK));
        /* 0x00A..=0x00B */
        assert_eq!(LinuxNonstandardEtherType::try_from(0x000C), Ok(LinuxNonstandardEtherType::CAN));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x000D), Ok(LinuxNonstandardEtherType::CANFD));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x000E), Ok(LinuxNonstandardEtherType::CANXL));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x0010), Ok(LinuxNonstandardEtherType::PPPTALK));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x0011), Ok(LinuxNonstandardEtherType::TR_802_2));
        /* 0x0012..=0x0014 */
        assert_eq!(LinuxNonstandardEtherType::try_from(0x0015), Ok(LinuxNonstandardEtherType::MOBITEX));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x0016), Ok(LinuxNonstandardEtherType::CONTROL));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x0017), Ok(LinuxNonstandardEtherType::IRDA));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x0018), Ok(LinuxNonstandardEtherType::ECONET));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x0019), Ok(LinuxNonstandardEtherType::HDLC));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x001A), Ok(LinuxNonstandardEtherType::ARCNET));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x001B), Ok(LinuxNonstandardEtherType::DSA));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x001C), Ok(LinuxNonstandardEtherType::TRAILER));
        /* 0x001D..=0x00F4 */
        assert_eq!(LinuxNonstandardEtherType::try_from(0x00F5), Ok(LinuxNonstandardEtherType::PHONET));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x00F6), Ok(LinuxNonstandardEtherType::IEEE802154));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x00F7), Ok(LinuxNonstandardEtherType::CAIF));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x00F8), Ok(LinuxNonstandardEtherType::XDSA));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x00F9), Ok(LinuxNonstandardEtherType::MAP));
        assert_eq!(LinuxNonstandardEtherType::try_from(0x00FA), Ok(LinuxNonstandardEtherType::MCTP));
        /* 0x00FB..=u16::MAX */
    }
    ...
    fn dbg() {
        let pairs = &[
            (LinuxNonstandardEtherType::N802_3, "0x0001 (Dummy type for 802.3 frames)"),
            (LinuxNonstandardEtherType::AX25, "0x0002 (Dummy protocol id for AX.25)"),
            (LinuxNonstandardEtherType::ALL, "0x0003 (Every packet)"),
            (LinuxNonstandardEtherType::N802_2, "0x0004 (802.2 frames)"),
            (LinuxNonstandardEtherType::SNAP, "0x0005 (SNAP: Internal only)"),
            (LinuxNonstandardEtherType::DDCMP, "0x0006 (DEC DDCMP: Internal only)"),
            (LinuxNonstandardEtherType::WAN_PPP, "0x0007 (Dummy type for WAN PPP frames)"),
            (LinuxNonstandardEtherType::PPP_MP, "0x0008 (Dummy type for PPP MP frames)"),
            (LinuxNonstandardEtherType::LOCALTALK, "0x0009 (Localtalk pseudo type)"),
            (LinuxNonstandardEtherType::CAN, "0x000C (CAN: Controller Area Network)"),
            (LinuxNonstandardEtherType::CANFD, "0x000D (CANFD: CAN flexible data rate)"),
            (LinuxNonstandardEtherType::CANXL, "0x000E (CANXL: eXtended frame Length)"),
            (LinuxNonstandardEtherType::PPPTALK, "0x0010 (Dummy type for Atalk over PPP)"),
            (LinuxNonstandardEtherType::TR_802_2, "0x0011 (802.2 frames)"),
            (LinuxNonstandardEtherType::MOBITEX, "0x0015 (Mobitex)"),
            (LinuxNonstandardEtherType::CONTROL, "0x0016 (Card specific control frames)"),
            ...
            (LinuxNonstandardEtherType::DSA, "0x001B (Distributed Switch Arch)"),
            (LinuxNonstandardEtherType::TRAILER, "0x001C (Trailer switch tagging)"),
            (LinuxNonstandardEtherType::PHONET, "0x00F5 (Nokia Phonet frame)"),
            (LinuxNonstandardEtherType::IEEE802154, "0x00F6 (IEEE802.15.4 frame)"),
            (LinuxNonstandardEtherType::CAIF, "0x00F7 (ST-Ericsson CAIF protocol)"),
            (LinuxNonstandardEtherType::XDSA, "0x00F8 (Multiplexed DSA protocol)"),
            (LinuxNonstandardEtherType::MAP, "0x00F9 (Qualcomm multiplexing and aggregation protocol)"),
            (LinuxNonstandardEtherType::MCTP, "0x00FA (Management component transport protocol packets)"),
        ];
